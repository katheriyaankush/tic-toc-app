 var ola_priority_api = '{     "status": "REGISTERED",     "data": {         "city": null,         "language": "english",         "registered_phone": "404102579",         "dialing_code": "+61",         "priority": "P99",         "driver_id": "089328b9-c0ca-4737-ab83-6e943f3e85a9",         "operator_id": "08fa22d3-8cf4-41f7-a091-defc0a9c6b3f",         "session_id": "ba774ce3-fa35-4309-a36c-3083c71af7ed",         "crn": null,         "ivr": {             "prompt": true,             "files": "ivr 350.7",             "priority": "P99",             "allowed_input": null,             "input_length_min": 0,             "input_length_max": 0,             "input_confirmation": false,             "meta_data": null,             "next": null         },         "whitelist": false,         "source": null,         "p99reason": "Offroad for AU driver selfie mask offroad driver after x hours",         "is_london": null,         "vehicle_category": "suv",         "article_id": "NA",         "article_name": "NA",         "article_path": "NA"     } }';
...
if(ola_priority_api)
{
	...
	else if (status=='UNREGISTERED')
	{
		...
		if(jsonObj.data.ivr)
		{
			...
			{
				// set main menu values
		var promptFlag=promptFlag.toString();
